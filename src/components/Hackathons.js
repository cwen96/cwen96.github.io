        ...
        <div className="container">
          <div className="new-section" id="hackathons">
            ...
            <div className="row">
              ...
              <div className="col-9">
                <h3 className="subtitle">Speech-to-Text Processing App (Python + Google Cloud API)</h3>
            ...
            <div className="row">
              ...
              <div className="col-9">
                <h3 className="subtitle">Political Bias Detection App (Python + Google Cloud API)</h3>
                <span className="date">Jan 2021</span>
                <ul className="remove-bullets">
