          ...
          <div className ="new-section" id="academia">
            <div className="container">
              ...
              <div className="row">
                ...
                <div className="col-9">
                  <h3 className="subtitle">Jericho Stewardship Group</h3> <span>Vancouver, BC</span>
                  <br /> <span className="date">Sep 2017 - Apr 2018</span>
                  <br /> <span className="role subtitle">Research Consultant</span>
